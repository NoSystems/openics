...
setup(
    ...
    keywords='openics, machine learning, vision, ai, icreativefactor, adafactor, icreativesystem',  # Optional
    ...
    data_files=[(['data/drone_360p.mp4'])],  # Optional
